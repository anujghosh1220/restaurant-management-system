...
def upgrade():
    ...
    with op.batch_alter_table('menu_item') as batch_op:
        ...
        batch_op.add_column(sa.Column('discount_percentage', sa.Float(), server_default='0.0'))
        batch_op.add_column(sa.Column('discount_start', sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column('discount_end', sa.DateTime(), nullable=True))
